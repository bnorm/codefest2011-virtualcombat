...
import dev.data.RobotManager;
import dev.data.robots.RobotData;
...
public class Test extends AdvancedRobot {
   ...
   private static final Scale[] scales = {
      new Distance(), new Velocity(), new LateralVelocity() };
   ...
   public void onScannedRobot(ScannedRobotEvent event) {
      ...
      if (this.setFireBullet(2.0) != null) {
         Vector<Object> center = new Vector<Object>(Arrays.asList(Test.scales),
               robots.getRobot(event.getName()), new RobotData(this), null);
         System.out.println("CENTER: " + center);

         // LinkedList<Object> vectors =
         space.getClustor(robots.getRobot(event.getName()),
               new RobotData(this), 10);
