...
public final class Trig {
   ...
   /* Lookup tables */
   private static double[]     sineTable           = new double[TRIG_DIVISIONS];
   private static double[]     tanTable            = new double[TRIG_HIGH_DIVISIONS];
   private static double[]     acosTable           = new double[TRIG_HIGH_DIVISIONS];
   ...
   static {
      new Thread(new Runnable() {
         @Override
         public void run() {
            sineTable = new double[TRIG_DIVISIONS];
            tanTable = new double[TRIG_HIGH_DIVISIONS];
            acosTable = new double[TRIG_HIGH_DIVISIONS];
