...
public class Utils {
   ...
   /**
    * Returns <code>value</code> limited to the <code>min</code> and <code>max</code>. That is, if <code>value</code> is
    * greater then <code>max</code>, <code>max</code> will be returned. If <code>value</code> is less then
    * <code>min</code>, <code>min</code> will be returned. Otherwise <code>value</code> will be returned.
    * 
    * @param min
    *           the smaller limiter
    * @param value
   ...
   public static final double normalize(double n, double min, double max) {
