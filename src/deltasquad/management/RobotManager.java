package deltasquad.management;

import java.util.HashMap;

import deltasquad.communication.Message;
...
public class RobotManager implements Drawable {
    ...
    * 
    * @see deltasquad.robot.RobotData
    */
   private static HashMap<String, RobotData>    robots;

   /**
    * An array of <code>{@link deltasquad.robot.EnemyData EnemyData}</code> that represent the enemies of the
    * <code>{@link robocode.Robot Robot}</code> that created this <code>class</code>.
    * 
    * @see deltasquad.robot.EnemyData
    */
   private static HashMap<String, EnemyData>    enemies;

   /**
    * An Array of <code>{@link deltasquad.robot.TeammateData TeammateData}</code> that represent the teammates of the
    * <code>{@link robocode.Robot Robot}</code> that created this <code>class</code>.
    * 
    * @see deltasquad.robot.TeammateData
    */
    ...
    * 
    * @param myRobot
    *           - the robot that is creating the class.
    */
    ...
    * 
    * @param myRobot
    *           - the robot that created the class.
    */
   private void init(final Robot myRobot) {
      robot = myRobot;
      info = new RobotInfo(myRobot);
      if (robots == null) {
    ...
    * 
    * @param srm
    *           a <code>ScannedRobotMessage</code>.
    */
   private void handleScannedRobot(final ScannedRobotMessage srm) {
      ...
      if (!r.isDummy()) {
         ...
         if (info.isTeammate(srm.getName())) {
    ...
    * <code>{@link deltasquad.robot.RobotData#DEAD DEAD}</code>.
    * 
    * @param rde
    *           a <code>RobotDeathEvent</code>.
    */
    ...
    * <code>{@link deltasquad.robot.RobotData#DEAD DEAD}</code>. In this way, when a new round starts, all robots will be
    * considered dead and will then be reset for a new round.
    * 
    * @param de
    *           a <code>DeathEvent</code>.
    */
   ...
   /**
    * Return an <code>array</code> of <code>{@link deltasquad.robot.RobotData RobotData}</code> <code>classes</code> that
   ...
   /**
    * Returns an <code>array</code> of <code>{@link deltasquad.robot.RobotData RobotData}</code> <code>classes</code> that
   ...
   /**
    * Returns an <code>array</code> of <code>{@link deltasquad.robot.EnemyData EnemyData}</code> <code>class</code> es that
   ...
   /**
    * Returns an <code>array</code> of <code>{@link deltasquad.robot.TeammateData TeammateData}</code> <code>classes</code>
   ...
   /**
    * Returns a <code>{@link deltasquad.robot.RobotData RobotData}</code> <code>class</code> that is chosen be a
    ...
    * 
    * @param chooser
    *           the <code>RobotChooser</code> <code>class</code> that chooses the best robot.
   ...
   /**
    * Returns a <code>{@link deltasquad.robot.EnemyData EnemyData}</code> <code>class</code> that is chosen be a
    * <code>RobotChooser</code> <code>class</code>. See
    * <code>{@link #getRobot(RobotChooser) getRobot(RobotChooser)}</code> for an example.
    * 
    * @param chooser
    *           the <code>RobotChooser</code> <code>class</code> that chooses the best enemy.
   ...
   /**
    * Returns a <code>{@link deltasquad.robot.TeammateData TeammateData}</code> <code>class</code> that is chosen be a
    * <code>RobotChooser</code> <code>class</code>. See
    * <code>{@link #getRobot(RobotChooser) getRobot(RobotChooser)}</code> for an example.
    * 
    * @param chooser
    *           the <code>RobotChooser</code> <code>class</code> that chooses the best teammate.
   ...
   /**
    * Returns the <code>{@link deltasquad.robot.RobotData RobotData}</code> who's name matches the passed <code>string</code>.
    * Will return a dummy robot if no match is found.
    * 
    * @param name
    *           the name of a possible robot.
   ...
   /**
    * Returns the <code>{@link deltasquad.robot.EnemyData EnemyData}</code> who's name matches the passed <code>string</code>.
    * Will return a dummy enemy if no match is found.
    * 
    * @param name
    *           the name of a possible enemy.
   ...
   /**
    * Returns the <code>{@link deltasquad.robot.TeammateData TeammateData}</code> who's name matches the passed
    * <code>string</code>. Will return a teammate robot if no match is found.
    * 
    * @param name
    *           the name of a possible teammate.
